...
<body>
  <div class="row affix-row">
    ...
    <div class="col-sm-9 col-md-9 affix-content ">
      <div class="leftpad">
        <form>
          <input class="form-control form-control-lg" type="text" placeholder="Enter name of Journey"> <!-- only if he has not entered the name of the journey already -->
      ...
      <nav class=" navbar1 navbar-default" >
        <div class="container-fluid">
          ...
          <ul class="nav navbar-nav">
            ...
            <li id="act2" class="active" onclick="students()"><a href="#students">Students</a></li>
